...
const Contact = () => {
  const marqueeTop = useRef();
  const marqueeBottom = useRef();

  // TOP marquee animation
  useEffect(() => {
    gsap.to(marqueeTop.current, {
      x: "-50%",
      duration: 15,
      repeat: -1,
      ease: "linear",
  ...
  return (
    <div className="w-full min-h-screen py-1 overflow-hidden">
      <Navigation />
      <div className="w-full mt-20  overflow-hidden bg-[#9AE600] ">
        <div
          ref={marqueeTop}
          className="flex  whitespace-nowrap gap-20 p-1 pb-5"
        >
          <MarqueeLine />
          <MarqueeLine />
        </div>
        ...
        <div className="w-[32%]  py-4 h-[77.8vh]   ">
          <div className="w-full py-13 px-6 hover:rotate-10 transition-transform duration-300   bg-[#9AE600] h-[88.5%] rounded-xl relative ">
            ...
            <div>
              ...
              <p className="text-md capitalize font-normal">corona, CA 92879</p>
            </div>
            <div className="mt-5">
              <h1 className="text-xl capitalize font-bold">contact</h1>
              <p className="text-md mt-1 font-normal capitalize ">
      ...
      <div className="w-full mt-10 bg-[#9AE600] overflow-hidden">
        <div
          ref={marqueeBottom}
          className="flex whitespace-nowrap gap-20 p-1 pb-5"
        >
...
const MarqueeLine = () => (
  <>
    <MarqueeItem text="with" />
    <MarqueeItem text="monster" />
    <MarqueeItem text="unleast" />
    <MarqueeItem text="the" />
    <MarqueeItem text="beast" />
  </>
);
